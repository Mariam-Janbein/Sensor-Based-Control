...
The paper is included in the repository "journal.pone.0283195.pdf".    
...
We worked on the DJI Tello drone in the lab, we installed the required libraries to work with python (https://github.com/damiafuentes/DJITelloPy/tree/master?tab=readme-ov-file).  
